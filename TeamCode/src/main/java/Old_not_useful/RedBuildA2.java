...
@Autonomous(name = "RedBuildA2")
@Disabled

public class RedBuildA2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(1500);
        SKY.armB2.setPower(0);
        moveBackwardsEncoders(.5,3150);
        sleep(50);
        //SKY.smackServo.setPosition(.75);
        sleep(1000);
        //SKY.smackServo.setPosition(0);
        SKY.armB2.setPower(-1);
        sleep(500);
    ...
    public void rampEncoders(int distance){
        ...
        while( SKY.left.isBusy() && SKY.right.isBusy()){
            while(opModeIsActive()&& SKY.left.getCurrentPosition()< distance) {
                SKY.power = SKY.left.getCurrentPosition() * 1/1000;
