...
//@Autonomous(name="Red_Straight_8")
public class Red_Straight_8 extends LinearOpMode {
        ...
        */
        do {
            ...
            if (opModeIsActive()&& vuMark == RelicRecoveryVuMark.LEFT) {
                ...
                NATARI.leftf.setPower(.6);
                NATARI.rightf.setPower(-.9);
                NATARI.leftb.setPower(-.9);
                NATARI.rightb.setPower(.6);
                ...
                while (opModeIsActive() && NATARI.rsideSensor.getDistance(DistanceUnit.CM) < 30) ;
                {
