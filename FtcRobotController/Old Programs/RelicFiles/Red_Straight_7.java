...
/*
    ...
    phone. This program is made for the Red Alliance, left most stone from driver perspective. This
...
//@Autonomous(name="Red_Straight_7")
public class Red_Straight_7 extends LinearOpMode {
        ...
        */
        do {
            ...
            if (opModeIsActive()&&vuMark == RelicRecoveryVuMark.LEFT) {
                ...
                while (opModeIsActive() && NATARI.rsideSensor.getDistance(DistanceUnit.CM) < 55) ;
                {
                ...
                while (opModeIsActive() && NATARI.rsideSensor.getDistance(DistanceUnit.CM) < 35) ;
                {
                ...
                while (opModeIsActive() && NATARI.rsideSensor.getDistance(DistanceUnit.CM) < 18) ;
                {
